...
Third party import:
    import mysql.connector(for windows, pip install mysql.connector.)
"""
...
class Model:
    ...
    def __init__(
        self, user="root", pw="admin", host="localhost", db_name="school"
    ) -> None:
    ...
    # These are not necessary to use in this specific project.
    # -----------------------------------------------------------------
